...
import imgnopost from '../../../assets/img-no-post.jpg';
            ...
            <div className='home-container'>
                {itemData.length === 0 ? (
                    <div className="no-posts">
                        <img src= {imgnopost} ></img>
                        <div className='title-no-post'>
                            Chia sẻ ảnh
                        </div>
                        <div className='desc-no-post'>
                            Khi bạn chia sẻ ảnh, ảnh sẽ xuất hiện trên trang cá nhân của bạn.
                        </div>
                        <div className='no-post-link'>
                            <Link> Chia sẻ ảnh đầu tiên của bạn</Link>
                        </div>
                    </div>
                ) : (
